...
COMPARE_RESPONSE_EXAMPLE = {
    ...
    "merged_output": {
        ...
        "structured_output": {
            ...
            "comparison_summary": ["Policy number changed between terms."],
            "field_level_changes": [
                {
                    "field": "policy_numbers[0]",
                    "current_value": "CPP1234567-89 (page 2)",
                    "prior_value": "CPP1234567-88 (page 2)",
                    "change_type": "changed",
                }
            ],
        },
